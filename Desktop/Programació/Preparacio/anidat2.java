...
/**
 * Aquest exercici demana a l'usuari les notes de Matemàtiques, Castella 
 * i Anglès. Després, segons la nota de Matemàtiques i comparant-la amb 
 * les altres, mostra diferents missatges:
 * - Classifica la nota de Matemàtiques (suspès, bé, notable o excel·lent).
 * - Compara la nota de Matemàtiques amb Castella i Anglès, i ofereix 
 *   recomanacions segons sigui superior, inferior o similar
 */
